...
st.set_page_config(
    ...
    menu_items={                           
        'Get Help': 'https://brumepascal.netlify.app/',
        'Report a bug': 'https://brumepascal.netlify.app/',
        'About': 'This app identifies plant diseases using a machine learning model.'
    }
)
...
model_path = os.path.join(working_dir, "plant_disease_prediction_model_V3.keras")
...
st.markdown("""
    Welcome to the Plant Disease Classifier! Upload an image of a plant leaf to identify possible diseases.
